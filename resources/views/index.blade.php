    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="#student-list">List</a></li>
                <li><a href="#student-add">Add new</a></li>
                <li><a href="#student-find">Find</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<div class="jumbotron text-center">
    <img src="https://logoeps.com/wp-content/uploads/2012/12/square-logo-vector.png" alt="logo" style="height: 250px">
</div>

<!-- Container (About Section) -->
<div id="student-list" class="container-fluid">
...
<div id="student-add" class="container text-center">
    ...
    <form class="form-horizontal" action="/add" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="roll-number" placeholder="Enter roll number" name="rollNumber">
            </div>
        </div>
        <div class="form-group">
